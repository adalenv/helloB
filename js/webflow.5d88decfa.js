...
! function(t) {
    ...
    r.resize = j(c, O), r.scroll = j(c, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), r.redraw = j(), r.location = function(t) {
        ...
        t = t || {}, v = !0, c.triggerHandler("__wf_destroy"), null != t.domready && (p = t.domready), l.each(i, g), r.resize.off(), r.scroll.off(), r.redraw.off(), o = [], a = [], "pending" === _.state() && I()
    ...
    e.f = function() {
        ...
        switch (n.actionTypeId) {
            ...
            case v.g:
                ...
                if (d === g.a) {
                    var w = c(e, g.F);
                    s(e, g.F, ""), m = f(e, "offsetWidth"), s(e, g.F, w)
                }
                if (p === g.a) {
                    var x = c(e, g.m);
        ...
        if (n) return function(t, e) {
            var n = t.element,
                ...
                c = function(t, e, n) {
                    ...
                    switch (r) {
                        case v.i:
                            return void 0 !== l && (h = q(h, k, g.B, l + a)), void 0 !== d && (h = q(h, C, g.C, d + c)), void 0 !== p && (h = q(h, M, g.D, p + f)), h;
                        case v.k:
                            return void 0 !== l && (h = q(h, P, g.u, l + a)), void 0 !== d && (h = q(h, L, g.v, d + c)), void 0 !== p && (h = q(h, R, g.w, p + f)), h;
                        case v.j:
                            return void 0 !== l && (h = q(h, D, g.r, l + a)), void 0 !== d && (h = q(h, N, g.s, d + c)), void 0 !== p && (h = q(h, V, g.t, p + f)), h;
                        case v.l:
                            return void 0 !== l && (h = q(h, z, g.y, l + a)), void 0 !== d && (h = q(h, $, g.z, d + c)), h;
                        default:
                            return h
                    }
                }(u, i, r);
            u !== c && (W(n, y.d, e), a(n, y.d, c), s = r, f = i.actionTypeId, l = s.xValue, d = s.yValue, p = s.zValue, (f === v.i && void 0 !== p || f === v.k && void 0 !== p || f === v.j && (void 0 !== l || void 0 !== d)) && a(n, y.e, g.q));
            var s, f, l, d, p
        }(t, e);
            ...
            switch (u) {
                case v.g:
                    var s = r.config,
                        ...
                        h = i.widthValue,
                        y = i.heightValue;
                    void 0 !== h && (l === g.a && (l = "px"), W(n, g.F, e), a(n, g.F, h + l)), void 0 !== y && (p === g.a && (p = "px"), W(n, g.m, e), a(n, g.m, y + p));
                    break;
                case v.d:
                case v.e:
                case v.h:
        ...
        if (i) return function(t, e) {
            ...
            switch (r.actionTypeId) {
                case v.b:
                    ...
                    return void(o === g.l && y.c ? i(n, g.k, y.b) : i(n, g.k, o))
            }
        }(t, e)
    }, e.b = function(t) {
        var e = t.store,
    ...
    var w = function(t) {
        ...
        _ = Object.freeze((b(i = {}, y.d, g.A), b(i, g.c, g.b), b(i, g.p, g.p), b(i, g.F, g.F), b(i, g.m, g.m), i)),
        O = 1;
    var j = function(t, e) {
        return t === e
    };
    ...
    function I(t) {
        ...
        return null == k || null == C ? [] : y.c && i ? s(C).filter(function(t) {
            return i.contains(t)
    ...
    function Q(t) {
        ...
        e.dispatch(Object(E.instanceAdded)(k({
            ...
            t.dispatch(Object(E.animationFrameChanged)(Number.POSITIVE_INFINITY, n)), Y(t.getState().ixInstances[e], t)
        }(e, o) : (Object(O.j)({
            store: e,
            select: function(t) {
    ...
    function Y(t, e) {
        var n = t.active,
            ...
            h = v.ixData,
            g = v.ixSession,
            y = (h.events[u] || {}).mediaQueries,
            m = void 0 === y ? h.mediaQueryKeys : y;
        if (Object(O.n)(m, g.mediaQueryKey) && (r || n || i) && ((o || l && i) && Object(O.m)(t, I), i)) {
            if (d) {
                var b = U({
                    store: e,
                    eventId: u,
    ...
    n(86), n(88), n(89), n(90), n(92), n(93), n(243), n(244), n(245), n(246), t.exports = n(247)
}, function(t, e, n) {
    var r = n(1);
    ...
    r.define("forms", t.exports = function(t, e) {
        ...
        function m(e, n) {
            ...
            i.handler = null, i.redirect = r.attr("data-redirect"), g.test(u) ? i.handler = O : u || (a ? i.handler = _ : y())
        }
    ...
    r.define("ix", t.exports = function(t, e) {
        ...
        return a.init = function(t) {
            ...
            o = !0, v.each(E), r.scroll.off(I), i.async(), g = [], y = [], m = []
        }, a.ready = function() {
    ...
    var c = function(t, e) {
            ...
            if (y && !m)
                for (var A = 0, k = u.length; A < k; A++) {
                    ...
                    for (var M = (h - b) / w, P = y.config.easing, L = Object(a.a)(P, M), R = 0, D = u.length; R < D; R++) {
                        var N = u[R],
                            V = y.config[N],
                            z = (m.config[N] - V) * L + V;
                        T[N] = z
    ...
    t.exports = function(t, e, n, g, y, m) {
        ...
        if (E && !O) return m || (m = new r), b || f(t) ? i(t, e, n, g, y, m) : o(t, e, x, n, g, y, m);
        if (!(n & l)) {
        ...
        z = h({}, C, {
            handler: (w = function(t, e) {
                var n = e.elementVisible,
                    r = t.event;
                return !t.store.getState().ixData.events[r.action.config.autoStopEventId] && e.triggered ? e : r.eventTypeId === p.v === n ? (I(t), h({}, e, {
                    triggered: !0
                })) : e
            }, function(t, e) {
                var n = h({}, e, {
    ...
    e.a = (y(r = {}, p.x, N()), y(r, p.y, V()), y(r, p.d, N()), y(r, p.c, V()), y(r, p.n, N(!1)), y(r, p.m, V(!1)), y(r, p.z, N()), y(r, p.A, V()), y(r, p.f, {
        types: "click",
        ...
        handler: function(t) {
            ...
            switch (u) {
                case p.B:
                    S = E ? Math.min(y, window.innerWidth) / window.innerWidth : Math.min(b, window.innerHeight) / window.innerHeight;
                    break;
                case p.o:
                    var k = M(),
                        C = k.scrollLeft,
            ...
            return I && (S > .95 || S < .05) && (S = Math.round(S)), (u !== p.e || A || A !== a.elementHovered) && (S = f ? 1 - S : S, e.dispatch(Object(d.parameterChanged)(T, S))), {
                elementHovered: A,
                clientX: y,
                clientY: b,
                pageX: x,
    ...
    }), y(r, p.v, z), y(r, p.w, z), y(r, p.r, h({}, C, {
    ...
    r.define("navbar", t.exports = function(t, e) {
        ...
        function T(t, e) {
            if (!t.open) {
                ...
                var i = A(t),
                    ...
                    s = t.el.height(),
                    l = t.el[0];
                if (I(0, l), y.intro(0, l), r.redraw.up(), a || f.on("tap" + p, t.outside), !e) {
        ...
        function k(t, e) {
            if (t.open) {
                ...
                var n = t.config;
                if (("none" === n.animation || !c.support.transform || n.duration <= 0) && (e = !0), y.outro(0, t.el[0]), f.off("tap" + p, t.outside), e) return c(t.menu).stop(), void s();
            ...
            function s() {
                t.menu.height(""), c(t.menu).set({
                    x: 0,
                    y: 0
                }), t.menu.removeClass(h), t.links.removeClass(g), t.overlay && t.overlay.children().length && (m.length ? t.menu.insertAfter(m) : t.menu.prependTo(t.parent), t.overlay.attr("style", "").hide()), t.el.triggerHandler("w-close")
            }
        }
        return u
    })
    ...
    r.define("tabs", t.exports = function(t) {
        ...
        function y() {
            n = f && r.env("design"), (e = u.find(d)).length && (e.each(w), r.env("preview") && !g && e.each(b), m(), r.redraw.on(o.redraw))
        }
        ...
        function x(e, n) {
            ...
            if (u !== e.current) {
                ...
                y.length && i.outro ? (y.each(h.outro), a(y).add("opacity " + i.outro + "ms " + o, {
                    fallback: s
                }).start({
                    opacity: 0
                }).then(m)) : m()
...
Webflow.require('ix').init([{
        ...
        "value": {
            ...
            "triggers": [{
                "type": "hover",
                "stepsA": [{
                    "transition": "transform 10000ms ease 0",
                    "scaleX": 1.5,
                    "scaleY": 1.5,
                    "scaleZ": 1
                }],
    ...
    {
        "slug": "how-bonsai-works-container",
        "name": "How Bonsai Works Container ",
        "value": {
            "style": {
                "opacity": 0,
                "x": "0px",
    ...
    {
        "slug": "close-how-bonsai-works",
        "name": "Close How Bonsai Works",
        "value": {
            "style": {},
            "triggers": [{
                "type": "click",
    ...
    {
        "slug": "close-pool-size-question",
        "name": "Close Pool Size Question",
        "value": {
            "style": {},
            "triggers": [{
                "type": "click",
    ...
    {
        "slug": "open-pool-size-question",
        "name": "Open Pool Size Question",
        "value": {
            "style": {},
            "triggers": [{
                "type": "click",
    ...
    {
        "slug": "global-item-float",
        "name": "Global Item Float",
        "value": {
            "style": {},
            "triggers": [{
                "type": "load",
                "loopA": true,
                "stepsA": [{
                    "transition": "transform 2500ms ease-in-out 0",
                    "x": "0px",
                    "y": "-20px",
                    "z": "0px"
                }, {
    ...
    {
        "slug": "global-item-float-2",
        "name": "Global Item Float 2",
        "value": {
            "style": {},
            "triggers": [{
                "type": "load",
                "loopA": true,
                "stepsA": [{
                    "transition": "transform 4500ms ease-in-out 0",
                    "x": "0px",
                    "y": "-20px",
                    "z": "0px"
                }, {
    ...
    {
        "slug": "global-item-float-3",
        "name": "Global Item Float 3",
        "value": {
            "style": {},
            "triggers": [{
                "type": "load",
                "loopA": true,
                "stepsA": [{
                    "transition": "transform 3000ms ease-in-out 0",
                    "x": "0px",
                    "y": "-20px",
                    "z": "0px"
                }, {
    ...
    },
    {
        ...
        "value": {
            ...
            "triggers": [{
                "type": "scroll",
                "selector": ".nav-bar-all-scrolling-hidden",
                "siblings": true,
                "preserve3d": true,
                "stepsA": [{
    ...
    {
        "slug": "modal-interaction-open",
        "name": "Modal Interaction - Open",
        "value": {
            "style": {},
            "triggers": [{
                "type": "click",
    ...
    {
        "slug": "modal-interaction-close",
        "name": "Modal Interaction - Close",
        "value": {
            "style": {},
            "triggers": [{
                "type": "click",
    ...
    },
    {
        ...
        "value": {
            ...
            "triggers": [{
                "type": "hover",
                "selector": ".recurring-billing-charge",
                "preserve3d": true,
                "stepsA": [{
                    "transition": "transform 200 ease 0",
                    "x": "-40px",
                ...
                "type": "hover",
                "selector": ".recurring-billing-card",
                "preserve3d": true,
                "stepsA": [{
                    "transition": "transform 200 ease 0",
                    "x": "20px",
    ...
    "events": {
        "e": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "59ef0932ef29b70001361881|59ef0932ef29b70001361882"
            },
            "config": {
                "loop": false,
                "scrollOffsetValue": 0,
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "59ef0932ef29b70001361881|0f371ec6-06c7-d590-5e28-40b7404c6cf5"
                        },
                        "yValue": -90,
                        "xUnit": "PX",
                        "yUnit": "PX",
